        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="far fa-user"></i> <span>Manage User</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="{{route('user.view')}}">Data User</a></li>
                  <li><a class="nav-link" href="{{route('user.add')}}">Tambah User</a></li>
                </ul>
              </li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="{{route('barang.view')}}">Data Barang</a></li>
                  <li><a class="nav-link" href="{{route('barang.add')}}">Tambah Barang</a></li>
                </ul>
              </li>
              <li class="menu-header">STNK</li>
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>STNK</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="{{route('stnk.view')}}">Data STNK</a></li>
                  <li><a class="nav-link" href="{{route('stnk.add')}}">Tambah Data STNK</a></li>
                </ul>
              </li>
